...
const FeaturesCarousel = () => {
    return (
      <Carousel variant='dark' style={{ maxWidth: '1000px', maxHeight: '600px', margin: '0 auto' }}>
        <Carousel.Item interval={3000}>
          <Image src='/balance.png' text="First slide" style={{ width: '100%', height: 'auto', borderRadius: 20 }} />
        ...
        <Carousel.Item interval={3000}>
          <Image src='/groups.png' text="Second slide" style={{ width: '100%', height: 'auto', borderRadius: 20 }} />
          <Carousel.Caption style={{backgroundColor: 'rgba(255, 255, 255, 0.7)', borderRadius: 20}}>
        ...
        <Carousel.Item interval={3000}>
          <Image src='/group.png' text="Third slide" style={{ width: '100%', height: 'auto', borderRadius: 20 }} />
          <Carousel.Caption style={{backgroundColor: 'rgba(255, 255, 255, 0.7)', borderRadius: 20}}>
